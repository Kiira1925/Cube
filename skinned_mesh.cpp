...
Skinned_Mesh::Skinned_Mesh(ID3D11Device* device, const char* fbxFilename,bool clockFlg)
{
    ...
    createVsFromCso(device, "./Shaders/skinned_not_light_vs.cso", vertexShader.GetAddressOf(), inputLayout.GetAddressOf(), input_element_desc, ARRAYSIZE(input_element_desc));
    createPsFromCso(device, "./Shaders/skinned_not_light_ps.cso", pixelShader.GetAddressOf());
